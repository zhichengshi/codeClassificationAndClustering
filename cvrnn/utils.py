...
def generateCodeMatrix(read_path, logdir, word2vec, dump_path, sampleFunc):  # 构建代码向量矩阵
    ...
    code_vectors = []
    labels = []
    for nodes, children, statement_len, label_vector in sampleFunc(read_path, word2vec):
        try:
